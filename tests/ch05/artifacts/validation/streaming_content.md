...
- **Hypotheses 2 to 5** lack corresponding test results and thus require execution of their respective test designs to enable proper validation and confidence updates.### Hypothesis 1
**Hypothesis:** Progressive capability transfer through staged reduction preserves reasoning performance in distilled models.
